...
| Implementation Phase 9 — device QA / PWA hardening | **Partial** — headless Chromium e2e (25 tests) green; real iPhone QA not done |
...
| 7 | CC0 assets | Done | Project-CC0 chibi chef/guests/surfaces/furniture + generated ingredient icons + Kenney audio; CREDITS.json + audit:assets; lazy atlases 1,972,972 B |
...
| 2026-07-29 | Rebuilt UI around the supplied chibi chef and espresso/gold reference: new project-CC0 room/furniture pipeline, mobile cooking overlay, desktop split workspace, and WASD/arrow controls; no gameplay-rule changes |
