...
| RISK-010 | 2026-07-24 | Economy pacing misses 200–400h target | Flat prestige cycle length (~6 days every cycle) | **Resolved (2026-07-24 / retired 2026-07-28):** Escalating prestige pacing via `prestigeRatingDeltaMultiplier` + capped `prestigeEconomyCostMultiplier` landed. Long-horizon deep sim (`test:sim`) that chased the 400h band was retired — flawed as a gate; complexity it drove stays. Fast suite keeps analytic proxy + short competent-play smoke. | Resolved |
